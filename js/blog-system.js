(function() {'use strict';const CONFIG = {articlesPerPage: 6,dataPath: 'data/articles.json',defaultImage: 'img/img-index/venta-de-extintores.avif'};let articlesData = null;function getBasePath() {const path = window.location.pathname;if (path.includes('/blog/')) {return '../';}return '';}
