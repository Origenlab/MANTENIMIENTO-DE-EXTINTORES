...
const carts = createProposalSeries({
  ...
  items: [
    ...
    offer('clase-d', 'Carro para extintor clase D', 'carro-para-extintor-clase-d', 'Clase D 30 lb compatible', 'Laboratorios y metalmecánica', 'se necesita desplazar un cilindro clase D y su aplicador', 'mantiene agente, manguera y aplicador organizados cerca del riesgo', 'modelo, metal, manguera, aplicador y ruedas', 'el agente debe seguir siendo compatible con el metal presente'),
