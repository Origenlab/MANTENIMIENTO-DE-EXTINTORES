...
- Pruebas: `tests/catalog-expansion-proposals.test.mjs`

## Qué incluye cada propuesta

Nombre, slug, canonical, diferenciación, agente/material, clases, variante, aplicación, sector, necesidad, valor, selección, limitaciones, keyword, intención, H1, title, meta, enlace de card, datos de cotización, fuentes, fecha de revisión, estado y prioridad.
