// ═══════════════════════════════════════════════════════════════════════════════
// GENERADOR HTML - PRODUCTO CATALOGO v2.0 COMPACTO
// Diseño compacto con sidebar, colores por categoría, menu/footer dinámicos
// ═══════════════════════════════════════════════════════════════════════════════
...
// Imágenes
const imgPrincipal = data.imagenesFilenames.principal;
...
const classSmallBadgesHtml = p.fireClasses.map(cls => {
  return `<span class="class-badge" style="background:${fireClassColors[cls] || '#666'};color:white;padding:0.2rem 0.5rem;font-size:0.7rem;">${cls}</span>`;
}).join('');
...
const productSchema = JSON.stringify({
  ...
  'image': 'https://mantenimientodeextintores.mx/productos/' + p.categoria + '/' + imgPrincipal,
        ...
        <aside class="sidebar">
          ...
          <div class="sidebar-widget">
            ...
            <div class="contact-widget-item">
              ...
              <div class="contact-info">
                <span>Horario</span>
                <strong>Lun-Vie 8:00-18:00</strong>
              </div>
            </div>
          </div>
          ...
          <div class="sidebar-widget cta-widget">
            ...
            <a href="https://wa.me/${e.whatsapp}?text=Hola%2C%20necesito%20asesoría%20sobre%20extintores" class="btn-cta" target="_blank">
              💬 Chatea con Nosotros
            </a>
          </div>
        </aside>
    ...
    <script>
      ...
      fetch('../../menu.html')
        ...
        .then(data => {
          ...
          // Inicializar menú después de cargarlo
          initMenu();
        });
